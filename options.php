	...
	//Featured Box 1
		$options[] = array(
			...
			'type' => 'text');
                ...
                $options[] = array(
                        'name' => __('First Featured Box Subheading', 'advertica-lite'),
                        'desc' => __('Enter subheading for first featured box.', 'advertica-lite'),
                        'id' => $advertica_shortname.'_fb1_first_part_subheading',
                        'std' => '',
                        'type' => 'text');
		...
		$options[] = array(
			...
			'type' => 'text');
                ...
                $options[] = array(
                        'name' => __('Second Featured Box Subheading', 'advertica-lite'),
                        'desc' => __('Enter subheading for second featured box.', 'advertica-lite'),
                        'id' => $advertica_shortname.'_fb2_second_part_subheading',
                        'std' => '',
                        'type' => 'text');
	...
	//Featured Box 3
		$options[] = array(
			...
			'type' => 'text');
                ...
                $options[] = array(
                        'name' => __('Third Featured Box Subheading', 'advertica-lite'),
                        'desc' => __('Enter subheading for third featured box.', 'advertica-lite'),
                        'id' => $advertica_shortname.'_fb3_third_part_subheading',
                        'std' => '',
                        'type' => 'text');
