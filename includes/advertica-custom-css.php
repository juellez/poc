...
<style type="text/css">
	...
	#skenav ul ul li a:hover{ color: <?php if(isset($breadcolor)){ echo $breadcolor; } ?>;}
	*::-moz-selection{ color: <?php if(isset($breadcolor)){ echo $breadcolor; } ?>;}
	::selection { color: <?php if(isset($breadcolor)){ echo $breadcolor; } ?>;}

	#skenav ul li.current_page_item > a,
	#skenav ul li.current-menu-ancestor > a,
	#skenav ul li.current-menu-item > a,
	#skenav ul li.current-menu-parent > a { color: <?php if(isset($bg_color)){ echo $bg_color; } ?>; }
	...
	if(isset($bread_type)) {
	if ($bread_type == "brcolor" && $pagetitlebg == Null ) {?>.full-bg-breadimage-fixed { background-color: <?php echo $breadcolor; ?>;
		background-image: url('/images/bwphoto-kids.png');
